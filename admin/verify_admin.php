<?php 
    ...
    {
        $pg = get_safe_value(urldecode(base64_decode($_GET['pg'])));
    }
    ...
    if(isset($_POST['submit']))
    {
        ...
        if ($varify_otp == $_SESSION['otp']) 
        {
            ...
            {
                unset($_SESSION['otp']);
                redirect('change_password_process_admin.php');
            }
            ...
            if ($pg == 'registration_admin') 
            {
                $result_update_status = mysqli_query($conn, "UPDATE admin SET status = 1 WHERE email = '$email'");
        ...
        <div class="row">
            ...
            <div>
                ...
                <div class="d-flex justify-content-center mt-3">
                    <a href="resend_email_admin.php" type="submit" role="button">Resend OTP</a>
                </div>
            </div>
        </div>
    </div>
